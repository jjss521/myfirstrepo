...
class ReportPage(ttk.Frame):
    ...
    def _create_widgets(self):
        # 标题
        title = ttk.Label(self, text="报表生成与导出",
                         font=("微软雅黑", 18, "bold"),
                         foreground="#37474F")
        ...
        ttk.Label(btn_frame, text="导出格式:",
                  font=("微软雅黑", 9)).pack(side="left", padx=(20, 2))
        ...
        self._export_mode_combo = ttk.Combobox(btn_frame,
            ...
            font=("微软雅黑", 9), state="readonly", width=18)
        ...
        self.preview = tk.Text(preview_frame, font=("Consolas", 9),
                               bg="#fafafa", wrap="word",
