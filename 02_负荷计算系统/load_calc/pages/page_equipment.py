...
from .equipment_dialogs import EquipmentEditDialog, BuildingEditDialog, KxReferenceEditorDialog, SubsystemEditDialog
...
class EquipmentPage(ttk.Frame):
    ...
    def _create_widgets(self):
        ...
        ttk.Label(header, text="设备管理",
                  font=("微软雅黑", 18, "bold"),
                  foreground="#4E342E").pack(side="left")

        ttk.Label(header, text="— 按建/构筑物分类管理",
                  font=("微软雅黑", 10),
    ...
    def _create_left_panel(self, parent):
        """左侧：建/构筑物树形导航"""
        # ════ Excel 导入专区 ════
        import_frame = tk.Frame(parent, bg="#e8f5e9", relief="solid", bd=1)
        ...
        self.import_btn.bind("<Enter>", lambda e: self.import_btn.configure(bg="#a5d6a7"))
        self.import_btn.bind("<Leave>", lambda e: self.import_btn.configure(bg="#c8e6c9"))
        ...
        import_frame.dnd_bind("<<DragEnter>>", lambda e: import_frame.configure(bg="#c8e6c9"))
        import_frame.dnd_bind("<<DragLeave>>", lambda e: import_frame.configure(bg="#e8f5e9"))
        ...
        self.filter_entry = ttk.Entry(filter_frame, font=("微软雅黑", 9))
    ...
    def _create_right_panel(self, parent):
        ...
        self.btn_add_equip = ttk.Button(equip_frame, text="➕ 添加设备",
                                        command=self._add_equipment, width=10)
        ...
        self.btn_add_bldg = ttk.Button(bldg_frame, text="🏗️ 添加建筑",
                                       command=self._add_building, width=10)
        ...
        self.btn_add_sub = ttk.Button(sub_frame, text="➕ 添加系统",
                                      command=self._add_subsystem, width=10)
