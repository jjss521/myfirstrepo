...
class Page10KV(ttk.Frame):
    ...
    def _create_widgets(self):
        ...
        tk.Label(title_frame, text="二期全厂10KV负荷总览",
        ...
        for key, title, color, unit in [
            ("hv_pc", "总有功功率", THEME["ACCENT_BLUE"], "kW"),
            ("hv_qc", "总无功功率", THEME["ACCENT_ORANGE"], "kvar"),
            ("hv_sc", "总视在功率", THEME["ACCENT_GREEN"], "kVA"),
            ("hv_pf", "功率因数", THEME["ACCENT_PURPLE"], ""),
            ("hv_rate", "变压器总容量", THEME["ACCENT_TEAL"], "kVA"),
        ]:
        ...
        # 数值单位说明
        unit_note = tk.Label(detail_frame,
    ...
    def refresh(self):
        ...
        self.cards["hv_pf"].update_value(f"{pf:.4f}",
                                          THEME["ACCENT_GREEN"] if pf >= 0.9 else THEME["ACCENT_ORANGE"])
